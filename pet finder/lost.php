    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="nav nav-tabs mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php">Lost &amp; Found</a>
                </li>
                <li class="nav-item">
    ...
    <div class="nav-space"> </div>
        ...
        <?php
            ...
            if(isset($_POST['lost'])) {
                ...
                echo '<br><br>';
                echo '<h2 style="text-align:center;"> Pets found within ' . $dfz . ' miles of ' . $user_zip . ' matching your description!</h2>';
                ...
                $sql = "SELECT * FROM lost_pets WHERE zip IN(".implode(',',$zips).") AND type='$type' AND gender='$gender' AND age='$age' AND size='$size' AND color='$color' AND breed='$breed'"; 
            ...
            if(!$numrows == 0) {   
                    ...
                    <div class="col-sm-3" style="margin-top:15px;">
                        ...
                        <div class="card-header text-center"> ' .$row['breed'] . '</div>
                            <br>
                            
                            <div style="text-align:center; margin-left:3px;"> 
                                <img src="upload/' . $row['image'] . '" class="img-thumbnail center" width="250" height="250" />
                            </div> 
                            <br>
                            <br>
