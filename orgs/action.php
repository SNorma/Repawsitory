...
include('../php_includes/db_conx.php');
    ...
    if(isset($_POST["action"])) {
        ...
        if($_POST["action"] == "Insert") {
            ...
            $query = " INSERT INTO pet_adopt (description, breed, hair, uid, name, color, gender, type, age, size,city,state,zip, image) VALUES ('".$description."','".$breed."','".$hair."','".$user_id."','".$name."', '".$color."', '".$gender."','".$type."','".$age."','".$size."','".$city."','".$state."','".$zip."','".$image."')";
     ...
     if($_POST["action"] == "Edit")
     {
      ...
      $hair = mysqli_real_escape_string($object->connect, $_POST["hair"]);
        ...
        $query = "UPDATE pet_adopt SET description = '".$description."',breed = '".$breed."',hair = '".$hair."',city = '".$city."',state = '".$state."',zip = '".$zip."', age = '".$age."',size = '".$size."',gender = '".$gender."', type = '".$type."',name = '".$name."', color = '".$color."', image = '".$image."' WHERE id = '".$_POST["user_id"]."'";
      $object->execute_query($query);
      echo 'Data Updated';
