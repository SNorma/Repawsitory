<?php
    ...
    // If you are a standar user, please leave!
    if($userlevel == 'a')
...
<body>
    ...
    <div class="container box" style="margins:20px;">
        <div class="col-md-8">
            <button type="button" name="add" id="add" class="btn btn-warning" data-toggle="collapse" data-target="#user_collapse"> Add Record</button>
        </div>
        ...
        <div id="user_collapse" class="collapse">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <textarea id="description" name="description" placeholder="Description, notes, or keywords..." class="form-control" rows="5" id="comment"></textarea>
                </div>
                ...
                <div align="center">
                    ...
                    <input type="submit" name="button_action" id="button_action" class="btn btn-danger" value="Insert" />
                </div>
            </form>
        </div>
        <br><br>
